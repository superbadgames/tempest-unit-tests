...
//Nothing to test yet for this one. It's all based on date with no return types. 
//At a future date the camera will be re-evaluated and then some tests should be added.