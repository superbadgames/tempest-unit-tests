...
BOOST_AUTO_TEST_CASE(Shader_Single_Shader_Program)
{
	S32 program1 = KE::Shader::Instance()->GetSpriteShader();
	S32 program2 = KE::Shader::Instance()->GetSpriteShader();

	BOOST_CHECK_EQUAL(program1, program2);
}
*/