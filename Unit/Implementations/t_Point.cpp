...
{
	TM::Point Point1 {3.0f, 6.0f, 9.0f};

	TM::Point Point(Point1);
...
{
	TM::Point v1 {20.0f, 30.0f, 40.0f};
	TM::Point v2 {5.0f, 5.0f, 5.0f};

	TM::Point difference = v1 - v2;
	...
	TM::Point v3 {20.0f, 30.0f};
	TM::Point v4 {5.0f, 5.0f, 5.0f};

	TM::Point difference2 = v3 - v4;
...
{
	TM::Point A {2.0f, 5.0f, 10.0f};
	TM::Point B {6.0f, 8.0f, 9.0f};
	...
	TM::Point D {2.0f, 5.0f};
	D.Make2D();
	TM::Point E {6.0f, 8.0f, 9.0f};
...
{
	TM::Point A {4.0f, 6.0f, 9.0f};
	TM::Point B {-3.0f, 7.0f, 3.0f};
...
{
	TM::Point v1 {10.0f, 20.0f, 30.0f};

	TM::Point quotient = v1 / 2.0f;
	...
	TM::Point v2 {10.0f, 20.0f};
	v2.Make2D();

	TM::Point quotient2 = v2 / 2.0f;
...
{
	TM::Point midValue {5.0f, 10.0f, 15.0f};
	TM::Point highValue {40.0f, 50.0f, 60.0f};
	highValue[3] = 2.0f;
	TM::Point lowValue {1.0f, 2.0f, 3.0f};
	lowValue[3] = 0.0f;
	TM::Point equalValue = midValue;
...
BOOST_AUTO_TEST_CASE(PointMagnitude) {
	TM::Point PointTest {5.0f, -4.0f, 10.0f};
...
{
	TM::Point PointTest {12.0f, -5.0f, 25.0f};
	PointTest.Normalize();
...
{
	TM::Point PointTest {12.0f, -5.0f, 20.0f};
...
{
	TM::Point PointTest {15.0f, 25.0f, 45.0f};
	TM::Point scaled {45.0f, 10.0f, 20.0f};
	...
	TM::Point PointTest2 {15.0f, 25.0f};
	PointTest2.Make2D();
...
BOOST_AUTO_TEST_CASE(PointCrossProduct) 
{
	...
	TM::Point cross = v1.CrossProduct(v2);
